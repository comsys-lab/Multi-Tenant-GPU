...
alex_inference_time = alex_end_time - alex_start_time
res_inference_time = res_end_time - res_start_time
vgg_inference_time = vgg_end_time - vgg_start_time
Sequential_inference_time = Sequential_end_time - Sequential_start_time

print(f"Alexnet Inference Time : {(alex_inference_time):.6f} seconds.")
print(f"Resnet18 Inference Time : {(res_inference_time):.6f} seconds.")
print(f"Vgg16 Inference Time : {(vgg_inference_time):.6f} seconds.")
print(f"Sequential Inference Time : {(Sequential_inference_time):.6f} seconds.")

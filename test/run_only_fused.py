...
# Execute '/usr/local/cuda/bin/nvcc -Xcompiler -fPIC -shared -o Fused_inference.so Fused_inference.cu' first.
...
def fused_inference(count, user_request, random_model, total, stopping, producer_status, finisher):
    # Copy data from CPU to GPU
    dll = ctypes.CDLL('./Fused_inference.so',mode=ctypes.RTLD_GLOBAL)
    host2gpu = dll.host2gpu
    host2gpu.argtypes = [POINTER(POINTER(c_float)),POINTER(POINTER(c_float)),POINTER(POINTER(c_float)),POINTER(POINTER(c_float)),
    ...
    #Fused Inference
    fused_inference = dll.fused_inference
    fused_inference.argtypes = [POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
    ...
    #Free data from GPU
    cudafree = dll.cudafree
    cudafree.argtypes = [POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
                        POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
                        POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
                        POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
                        POINTER(c_float),POINTER(c_float),POINTER(c_float),POINTER(c_float),
...
##################################################################################
    host2gpu(A_L1_N,A_L2_N,A_L3_N,A_L4_N,
    ...
    # warm up
    for i in range(5):
        fused_inference(A_L1_N,A_L2_N,A_L3_N,A_L4_N,
                        A_L5_N,A_L6_N,A_L7_N,A_L8_N,
                        A_L1_b,A_L2_b,A_L3_b,A_L4_b,
                        A_L5_b,A_L6_b,A_L7_b,A_L8_b,
                        A_L1_w,A_L2_w,A_L3_w,A_L4_w,
    ...
    # queueing_delay_alexnet = Queue()
    # queueing_delay_resnet18 = Queue()
    # queueing_delay_vgg16 = Queue()
    ...
    while True:
        if(user_request.empty()):
            ...
            file = open("result_only_fused.txt","a")
            ...
            if request_count > (total - 1):
                ...
                for i in range(5):
                    ...
                    if random_model[0] == 'alexnet':
                        ...
                        if queueing_delay < 0:
                            queueing_delay = 0
                        # queueing_delay_alexnet.put(queueing_delay) 
                    elif random_model[0] == 'resnet18':
                        del random_model[0]
                        res_num += 1
                        if queueing_delay < 0:
                            queueing_delay = 0
                        # queueing_delay_resnet18.put(queueing_delay)
                    elif random_model[0] == 'vgg16':
                        del random_model[0]
                        vgg_num += 1
                        if queueing_delay < 0:
                            queueing_delay = 0
                        # queueing_delay_vgg16.put(queueing_delay)
                    else:
                        continue
                ...
                for i in range(5):
                    ...
                    # file.write("Fused model(Alex:{} ,Res:{} ,Vgg:{})" f"\t{(q_d):.6f} \t {(inference_time):.6f}\n".format(alex_num,res_num,vgg_num))
    ...
    cudafree(A_L1_N,A_L2_N,A_L3_N,A_L4_N,
            A_L5_N,A_L6_N,A_L7_N,A_L8_N,
            A_L1_b,A_L2_b,A_L3_b,A_L4_b,
            A_L5_b,A_L6_b,A_L7_b,A_L8_b,
            A_L1_w,A_L2_w,A_L3_w,A_L4_w,
...
if __name__ == '__main__':
    ...
    children.append(Process(target=fused_inference, args=(count, user_request, random_model, total, stopping, producer_status, finisher)))

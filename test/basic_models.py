...
if __name__ == '__main__':
    ...
    for _ in range(10):
        ...
        inference_alexnet(A_L1_N,A_L2_N,A_L3_N,A_L4_N,
                        ...
                        A_L1_pool,A_L2_pool,A_L5_pool,
                        A_L1_norm,A_L2_norm,A_Result_N)
        alex_endtime = time.time()

        res_starttime = time.time()
        inference_resnet18(R_L1_N,R_L2_N,R_L3_N,R_L4_N,
                                ...
                                R_L17_bn,R_B3_bn,R_B4_bn,R_B5_bn,
                                R_L1_pool,R_FC_N,R_Result_N)
        res_endtime = time.time()

        vgg_starttime = time.time()
        inference_vgg16(V_L1_N,V_L2_N,V_L3_N,V_L4_N,
                            ...
                            V_L2_pool,V_L4_pool,V_L7_pool,V_L10_pool,
                            V_L13_pool,V_Result_N)
        vgg_endtime = time.time()

        print(f"Alex inference time : {(alex_endtime - alex_starttime):.6f} seconds")
        print(f"Res inference time : {(res_endtime - res_starttime):.6f} seconds")
        print(f"Vgg inference time : {(vgg_endtime - vgg_starttime):.6f} seconds")

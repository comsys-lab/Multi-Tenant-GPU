...
void sequential_inference(float *Alex_Layer1_Neurons,float *Alex_Layer2_Neurons,float *Alex_Layer3_Neurons,float *Alex_Layer4_Neurons,
					float *Alex_Layer5_Neurons,float *Alex_Layer6_Neurons,float *Alex_Layer7_Neurons,float *Alex_Layer8_Neurons,
                    float *Alex_Layer1_bias,float *Alex_Layer2_bias,float *Alex_Layer3_bias,float *Alex_Layer4_bias,
                    float *Alex_Layer5_bias,float *Alex_Layer6_bias,float *Alex_Layer7_bias,float *Alex_Layer8_bias,
                    float *Alex_Layer1_Weights,float *Alex_Layer2_Weights,float *Alex_Layer3_Weights,float *Alex_Layer4_Weights,
...
/* 1st Layer */
    dim3 Vgg_Block1_Block(64,32,32);
	first<<<Vgg_Block1_Block,Block_Thread>>>(Vgg_Layer1_bias,Vgg_Layer1_Neurons,Vgg_Layer1_Weights,Vgg_Layer2_Neurons,224,224,1,1,3,3,true,true);

    /* 2nd Layer */
	conv<<<Vgg_Block1_Block,Block_Thread>>>(Vgg_Layer2_bias,Vgg_Layer2_Neurons,Vgg_Layer2_Weights,Vgg_Layer2_pool,224,224,1,1,3,64,true,true);

	dim3 Vgg_Block1_Pool_Block(64,16,16);
    max<<<Vgg_Block1_Pool_Block,Block_Thread>>>(Vgg_Layer2_pool,Vgg_Layer3_Neurons,224,112,2,0,2);

    /* 3rd Layer */
	dim3 Vgg_Block2_Block(128,16,16);
	conv<<<Vgg_Block2_Block,Block_Thread>>>(Vgg_Layer3_bias,Vgg_Layer3_Neurons,Vgg_Layer3_Weights,Vgg_Layer4_Neurons,112,112,1,1,3,64,true,true);

	/* 4th Layer */    
	conv<<<Vgg_Block2_Block,Block_Thread>>>(Vgg_Layer4_bias,Vgg_Layer4_Neurons,Vgg_Layer4_Weights,Vgg_Layer4_pool,112,112,1,1,3,128,true,true);

	dim3 Vgg_Block2_Pool_Block(128,8,8);
    max<<<Vgg_Block2_Pool_Block,Block_Thread>>>(Vgg_Layer4_pool,Vgg_Layer5_Neurons,112,56,2,0,2);

    /* 5th Layer */
	dim3 Vgg_Block3_Block(256,8,8);
	conv<<<Vgg_Block3_Block,Block_Thread>>>(Vgg_Layer5_bias,Vgg_Layer5_Neurons,Vgg_Layer5_Weights,Vgg_Layer6_Neurons,56,56,1,1,3,128,true,true);

    /* 6th Layer */
    conv<<<Vgg_Block3_Block,Block_Thread>>>(Vgg_Layer6_bias,Vgg_Layer6_Neurons,Vgg_Layer6_Weights,Vgg_Layer7_Neurons,56,56,1,1,3,256,true,true);

    /* 7th Layer */
	conv<<<Vgg_Block3_Block,Block_Thread>>>(Vgg_Layer7_bias,Vgg_Layer7_Neurons,Vgg_Layer7_Weights,Vgg_Layer7_pool,56,56,1,1,3,256,true,true);

	dim3 Vgg_Block3_Pool_Block(256,4,4);
    max<<<Vgg_Block3_Pool_Block,Block_Thread>>>(Vgg_Layer7_pool,Vgg_Layer8_Neurons,56,28,2,0,2);

    /* 8th Layer */
	dim3 Vgg_Block4_Block(512,4,4);
	conv<<<Vgg_Block4_Block,Block_Thread>>>(Vgg_Layer8_bias,Vgg_Layer8_Neurons,Vgg_Layer8_Weights,Vgg_Layer9_Neurons,28,28,1,1,3,256,true,true);

    /* 9th Layer */
    conv<<<Vgg_Block4_Block,Block_Thread>>>(Vgg_Layer9_bias,Vgg_Layer9_Neurons,Vgg_Layer9_Weights,Vgg_Layer10_Neurons,28,28,1,1,3,512,true,true);

    /* 10th Layer */
    conv<<<Vgg_Block4_Block,Block_Thread>>>(Vgg_Layer10_bias,Vgg_Layer10_Neurons,Vgg_Layer10_Weights,Vgg_Layer10_pool,28,28,1,1,3,512,true,true);

	dim3 Vgg_Block4_Pool_Block(512,2,2);
    max<<<Vgg_Block4_Pool_Block,Block_Thread>>>(Vgg_Layer10_pool,Vgg_Layer11_Neurons,28,14,2,0,2);

    /* 11th Layer */
	dim3 Vgg_Block5_Block(512,2,2);
	conv<<<Vgg_Block5_Block,Block_Thread>>>(Vgg_Layer11_bias,Vgg_Layer11_Neurons,Vgg_Layer11_Weights,Vgg_Layer12_Neurons,14,14,1,1,3,512,true,true);

    /* 12th Layer */
    conv<<<Vgg_Block5_Block,Block_Thread>>>(Vgg_Layer12_bias,Vgg_Layer12_Neurons,Vgg_Layer12_Weights,Vgg_Layer13_Neurons,14,14,1,1,3,512,true,true);

    /* 13th Layer */
    conv<<<Vgg_Block5_Block,Block_Thread>>>(Vgg_Layer13_bias,Vgg_Layer13_Neurons,Vgg_Layer13_Weights,Vgg_Layer13_pool,14,14,1,1,3,512,true,true);

	dim3 Vgg_Block5_Pool_Block(512,1,1);
    max<<<Vgg_Block5_Pool_Block,Block_Thread>>>(Vgg_Layer13_pool,Vgg_Layer14_Neurons,14,7,2,0,2);
	...
	printf("Sequential inference time in CUDA: %f seconds\n", inference_time/1000);
...
//////////////////////////////////////////////// 
	...
	while(fgets(buffer1, 1000, list1) != NULL){
		line_count1++;
		if(line_count1 == (index1+1)){
			// printf("\n---Alexnet Result---");
			// printf("\nClass ID: %d\nClass Name: %sProbability: %f\n", index1, buffer, max1);
			printf("\nAlexnet: %d, %s", index1, buffer1);
			break;
		}
	}
	fclose(list1);
...
//////////////////////////////////////////////// 
	...
	int index2 = 0; 
	for(int i = 0; i < 1000; i++){
		if(max2 < Res_Result_Neurons_CPU[i]){
			max2 = Res_Result_Neurons_CPU[i];	
			index2 = i;
		}
	}
	...
	while(fgets(buffer2, 1000, list2) != NULL){
		line_count2++;
		if(line_count2 == (index1+1)){
			// printf("\n---Resnet18 Result---");
			// printf("\nClass ID: %d\nClass Name: %sProbability: %f\n", index1, buffer, max1);
			printf("\nResnet18: %d, %s", index2, buffer2);
			break;
		}
	}
	fclose(list2);
...
//////////////////////////////////////////////// 
	...
	int index3 = 0; 
	for(int i = 0; i < 1000; i++){
		if(max3 < Vgg_Result_Neurons_CPU[i]){
			max3 = Vgg_Result_Neurons_CPU[i];	
			index3 = i;
		}
	}
	...
	while(fgets(buffer3, 1000, list3) != NULL){
		line_count3++;
		if(line_count3 == (index1+1)){
			// printf("\n---Vgg16 Result---");
			// printf("\nClass ID: %d\nClass Name: %sProbability: %f\n", index1, buffer, max1);
			printf("\nVgg16: %d, %s", index3, buffer3);
			break;
		}
	}
	fclose(list3);

...
def merge_fused_inference(count, user_request, random_model, total, stopping, producer_status, finisher):
    ...
    while True:
        if(user_request.empty()):
            ...
            file = open("result_two_fused_sequence.txt","a")
...
if __name__ == '__main__':
    ...
    children.append(Process(target= merge_fused_inference, args=(count, user_request, random_model, total, stopping, producer_status, finisher)))

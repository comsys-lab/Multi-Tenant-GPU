...
void read_input(float *Layer1_Neurons_CPU){
	read_parameter("data_caffe/input_ts.txt", Layer1_Neurons_CPU);
}
...
void read_bias(float *Layer1_bias_CPU,float *Layer2_bias_CPU,float *Layer3_bias_CPU,float *Layer4_bias_CPU,float *Layer5_bias_CPU,float *Layer6_bias_CPU,float *Layer7_bias_CPU,float *Layer8_bias_CPU){
	read_parameter("data_caffe/bias1.txt", Layer1_bias_CPU);
	read_parameter("data_caffe/bias2.txt", Layer2_bias_CPU);
	read_parameter("data_caffe/bias3.txt", Layer3_bias_CPU);
	read_parameter("data_caffe/bias4.txt", Layer4_bias_CPU);
	read_parameter("data_caffe/bias5.txt", Layer5_bias_CPU);
	read_parameter("data_caffe/bias6.txt", Layer6_bias_CPU);
	read_parameter("data_caffe/bias7.txt", Layer7_bias_CPU);
	read_parameter("data_caffe/bias8.txt", Layer8_bias_CPU);
}
...
void read_weights(float *Layer1_Weights_CPU,float *Layer2_Weights_CPU,float *Layer3_Weights_CPU,float *Layer4_Weights_CPU,float *Layer5_Weights_CPU,float *Layer6_Weights_CPU,float *Layer7_Weights_CPU,float *Layer8_Weights_CPU){
	read_parameter("data_caffe/conv1.txt", Layer1_Weights_CPU);
	read_parameter("data_caffe/conv2.txt", Layer2_Weights_CPU);
	read_parameter("data_caffe/conv3.txt", Layer3_Weights_CPU);
	read_parameter("data_caffe/conv4.txt", Layer4_Weights_CPU);
	read_parameter("data_caffe/conv5.txt", Layer5_Weights_CPU);
	read_parameter("data_caffe/fc6.txt", Layer6_Weights_CPU);
	read_parameter("data_caffe/fc7.txt", Layer7_Weights_CPU);
	read_parameter("data_caffe/fc8.txt", Layer8_Weights_CPU);
}
...
void NeuralNetwork(){
    ...
    dim3 Conv_Block(96,5,5);
    dim3 Conv_thread(11,11);
    first_jjb<<<Conv_Block,Conv_thread>>>(Layer1_bias,Layer1_Neurons,Layer1_Weights,Layer1_norm,227,55,4,0,11,3);
	
    cudaMalloc((void**) &Layer1_pool, (L1_OUT*L1_FM_SIZE) * sizeof(float)); //96*55*55

	// /* Normalization of First Layer */
	dim3 Norm11_Block(96,5,5);
	...
	// GPU 1
	conv_split_jjb<<<Layer2_Block,Layer2_Thread>>>(Layer2_bias,Layer2_Neurons,Layer2_Weights,Layer2_norm,27,27,1,2,5,48,0,0);
	// GPU 2
	conv_split_jjb<<<Layer2_Block,Layer2_Thread>>>(Layer2_bias,Layer2_Neurons,Layer2_Weights,Layer2_norm,27,27,1,2,5,48,128,1);
    ...
    conv_jjb<<<Layer3_Block,Layer3_Thread>>>(Layer3_bias, Layer3_Neurons, Layer3_Weights, Layer4_Neurons,13,13,1,1,3,256);
	...
	// GPU 1
	conv_split_jjb<<<Layer4_Block,Layer4_Thread>>>(Layer4_bias,Layer4_Neurons,Layer4_Weights,Layer5_Neurons,13,13,1,1,3,192,0,0);
	// GPU 2
	conv_split_jjb<<<Layer4_Block,Layer4_Thread>>>(Layer4_bias,Layer4_Neurons,Layer4_Weights,Layer5_Neurons,13,13,1,1,3,192,192,1);
	...
	// GPU 1
	conv_split_jjb<<<Layer5_Block,Layer5_Thread>>>(Layer5_bias, Layer5_Neurons, Layer5_Weights, Layer5_pool,13,13,1,1,3,192,0,0);
	// GPU 2
	conv_split_jjb<<<Layer5_Block,Layer5_Thread>>>(Layer5_bias, Layer5_Neurons, Layer5_Weights, Layer5_pool,13,13,1,1,3,192,128,1);
